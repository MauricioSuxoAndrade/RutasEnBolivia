...
} from "./chunk-PUR2EJD4.js";
import {
  getOverlayAlpha_default,
  useTheme
} from "./chunk-4AYNWX6G.js";
import {
  createBox
} from "./chunk-CNIQ4OUA.js";
import {
  useRtl
} from "./chunk-QXU6IXUN.js";
import {
  createSvgIcon,
  debounce_default,
...
} from "./chunk-FQPC46BH.js";
import {
  capitalize_default
} from "./chunk-ZOGAVBKM.js";
import {
  useDefaultProps
} from "./chunk-HAB2DG6L.js";
import {
  rootShouldForwardProp_default,
  slotShouldForwardProp_default,
  styled_default
} from "./chunk-IRPO4TJT.js";
import {
...
var Portal = React12.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React12.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React12.isValidElement(children2)) {
      const newProps = {
        ref: handleRef
      };
      return React12.cloneElement(children2, newProps);
    }
...
var InputBase = React16.forwardRef(function InputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsxs)(React16.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, (0, import_jsx_runtime11.jsxs)(Root, _extends({}, rootProps, !isHostComponent_default(Root) && {
...
var Button = React21.forwardRef(function Button2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsxs)(ButtonRoot, _extends({
    ownerState,
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime17.jsxs)(React22.Fragment, {
    ...
    }), React22.cloneElement(children2, {
      ref: handleRef,
      onFocus
  ...
  return (0, import_jsx_runtime18.jsx)(Portal_default, {
    ...
    children: (0, import_jsx_runtime19.jsxs)(RootSlot, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime18.jsx)(BackdropSlot, _extends({}, backdropProps)) : null, (0, import_jsx_runtime18.jsx)(FocusTrap_default, {
        ...
        open,
        children: React24.cloneElement(children2, childProps)
      })]
    }))
  });
});
...
var FormControl = React26.forwardRef(function FormControl2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFormControl"
  });
  ...
  const [adornedStart, setAdornedStart] = React26.useState(() => {
    let initialAdornedStart = false;
    if (children2) {
      React26.Children.forEach(children2, (child) => {
  ...
  const [filled, setFilled] = React26.useState(() => {
  ...
  return (0, import_jsx_runtime21.jsx)(FormControlContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime21.jsx)(FormControlRoot, _extends({
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref
...
var _span;
var _excluded13 = ["children", "className", "component", "disabled", "error", "filled", "focused", "margin", "required", "variant"];
...
var FormHelperText = React27.forwardRef(function FormHelperText2(inProps, ref) {
  ...
  return (0, import_jsx_runtime22.jsx)(FormHelperTextRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
var _excluded14 = ["children", "className", "color", "component", "disabled", "error", "filled", "focused", "required"];
...
var FormLabel = React28.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime23.jsxs)(FormLabelRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
var Grow = React29.forwardRef(function Grow2(props, ref) {
  ...
  return (0, import_jsx_runtime24.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React29.cloneElement(children2, _extends({
        style: _extends({
          opacity: 0,
...
var _excluded20 = ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "onKeyDown", "variant"];
...
var Popover = React36.forwardRef(function Popover2(inProps, ref) {
  ...
  return (0, import_jsx_runtime32.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent_default(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
    children: (0, import_jsx_runtime32.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime32.jsx)(PaperSlot, _extends({}, paperProps, {
        children: children2
      }))
    }))
  }));
...
var Menu = React37.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime33.jsx)(MenuMenuList, _extends({
...
function NotchedOutline(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(NotchedOutlineRoot, _extends({
    "aria-hidden": true,
    className,
    ownerState
  }, other, {
...
var _excluded26 = ["components", "fullWidth", "inputComponent", "label", "multiline", "notched", "slots", "type"];
...
var OutlinedInput = React39.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime36.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime36.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime35.jsxs)(React39.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var _excluded27 = ["className", "disabled", "error", "IconComponent", "inputRef", "variant"];
...
var NativeSelectInput = React40.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime38.jsxs)(React40.Fragment, {
    children: [(0, import_jsx_runtime37.jsx)(NativeSelectSelect, _extends({
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref
    }, other)), props.multiple ? null : (0, import_jsx_runtime37.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var _span4;
var _excluded28 = ["aria-describedby", "aria-label", "autoFocus", "autoWidth", "children", "className", "defaultOpen", "defaultValue", "disabled", "displayEmpty", "error", "IconComponent", "inputRef", "labelId", "MenuProps", "multiple", "name", "onBlur", "onChange", "onClose", "onFocus", "onOpen", "open", "readOnly", "renderValue", "SelectDisplayProps", "tabIndex", "type", "value", "variant"];
...
var SelectInput = React41.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime40.jsxs)(React41.Fragment, {
    children: [(0, import_jsx_runtime39.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span4 || (_span4 = (0, import_jsx_runtime39.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
    })), (0, import_jsx_runtime39.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime39.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime39.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
var _excluded29 = ["autoWidth", "children", "classes", "className", "defaultOpen", "displayEmpty", "IconComponent", "id", "input", "inputProps", "label", "labelId", "MenuProps", "multiple", "native", "onClose", "onOpen", "open", "renderValue", "SelectDisplayProps", "variant"];
...
var Select = React43.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime42.jsx)(React43.Fragment, {
...
//# sourceMappingURL=chunk-Y2H6GTVJ.js.map
