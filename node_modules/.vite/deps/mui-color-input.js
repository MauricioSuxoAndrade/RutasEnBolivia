...
import "./chunk-PUR2EJD4.js";
import {
  Slider_default
} from "./chunk-GL42GBBM.js";
import "./chunk-4AYNWX6G.js";
import "./chunk-CNIQ4OUA.js";
import "./chunk-HSRHJKXL.js";
import "./chunk-QXU6IXUN.js";
import "./chunk-FQPC46BH.js";
import "./chunk-ZOGAVBKM.js";
import "./chunk-HAB2DG6L.js";
import {
  styled_default
} from "./chunk-IRPO4TJT.js";
import "./chunk-P4DBN6LU.js";
...
var h = class _h {
   ...
   */
  mix(e, t = 50) {
    const n = this.toRgb(), a = new _h(e).toRgb(), s = t / 100, o = {
      r: (a.r - n.r) * s + n.r,
      g: (a.g - n.g) * s + n.g,
      b: (a.b - n.b) * s + n.b,
      a: (a.a - n.a) * s + n.a
  ...
  monochromatic(e = 6) {
    ...
    const o = [], i = 1 / e;
    for (; e--; )
      o.push(new _h({ h: n, s: a, v: s })), s = (s + i) % 1;
    return o;
  }
  splitcomplement() {
  ...
  polyad(e) {
    ...
    for (let o = 1; o < e; o++)
      a.push(new _h({ h: (n + o * s) % 360, s: t.s, l: t.l }));
    return a;
  }
  /**
   ...
   */
  equals(e) {
    return this.toRgbString() === new _h(e).toRgbString();
  }
};
function F(r, e) {
  return r.toString(e);
